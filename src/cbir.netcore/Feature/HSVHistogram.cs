...
{
    public class HSVHistogram : IFeature
    {
        ...
        public virtual double CalculateSimilarity(IFeature feature)
        {
            ...
            else if (feature is HSVHistogram)
            {
                return ImageUtil.CalculateSimilarity(this.featureMatrix, (feature as HSVHistogram).featureMatrix);
            }
            else
            {
